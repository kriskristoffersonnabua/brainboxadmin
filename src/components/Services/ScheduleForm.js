...
class ScheduleForm extends React.Component {
	constructor(props) {
		...
		this.amDuration = React.createRef()
		this.pmDuration = React.createRef()
	}
	...
	resetForm = () => {
		console.log(this.amDuration)
		this.amDuration.current.props.value = null
		this.setState({
			date: null,
			morningtime: null,
			morningduration: null,
			afternoontime: null,
			afternoonduration: null
		})
	}
	saveSchedule = () => {
